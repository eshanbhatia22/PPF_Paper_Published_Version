...
Section~\ref{Method-Overheads}. \pg{this whole ``bits'' discussion
  belongs in implementation not here IMHO}
...
tables. \pg{the fact that its nine is again implementation details}
...
used to train the perceptron to %Gino: Filer? [EB]: Resolved
...
\item \textbf{Feature Selection:} In Section~\ref{Impl-Features}, we
  ...
  feature set for PPF. \pg{This should be more about how one should
