...
\begin{figure}
  \begin{center}
  \includegraphics[width=8cm]{PPF_Hierarchy.pdf}
...
magnitudes: PERC\_THRESHOLD\_HI and PERC\_ THRESHOLD\_ LO.

Prefetches whose sum exceeds PERC\_THRESHOLD\_HI are placed into the L2 cache.
...
between PERC\_THRESHOLD\_LO and PERC\_THRESHOLD\_HI is allocated in the larger
...
than PERC\_THRESHOLD\_LO are not prefetched, as the low confidence value
...
thresholds are referred to as POS\_UPDATE\_THRESHOLD ($\theta_p$) and \newline
