...
prefetch suggestions of the base prefetcher. As shown in step 1
...
\noindent \textbf{Making Base Prefetcher More Aggressive:} By Tuning 
...
the relevant meta-data must be exported from the prefetcher to PPF. This way,
PPF can be optimized to work tightly-knit with the base prefetcher.
