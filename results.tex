...
%%     \centering
%%     \includegraphics[width=0.45\columnwidth]{CloudSuite}
%%     \caption{CloudSuite Workloads}
%%   \end{subfigure}
%%   %
%%   \begin{subfigure}{0.5\columnwidth}
%%     \centering
%%     \includegraphics[width=0.45\columnwidth]{SPEC2006}
%%     \caption{Single Core SPEC CPU 2006}
%%   \end{subfigure}
%%   \caption{Performance with Unseen Benchmarks}
%%   \label{Fig:CrossVal}
%% \end{figure}
