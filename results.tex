...
Figure~\ref{Fig:CrossVal}(a) shows the speed-up achieved by BOP, SPP and
PPF on the memory intensive subset and the full SPEC CPU 2006 suite for a
...
Figure~\ref{Fig:CrossVal}(b) shows the performance benefit comparison of all
