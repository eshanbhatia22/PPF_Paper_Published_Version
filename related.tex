...
A similar work also proposed using perceptrons for filtering useless 
prefetches~\cite{ArxivPerc}. They implemented a basic Rosenblatt perceptron, using 
general error-correction learning. While they are able to reduce useless 
prefetches, they do not explore allowing the base-prefetcher to prefetch
unrestrained down the speculative path. Their design results in
increased accuracy but lowered cache coverage with low impact on
 overall performance.
