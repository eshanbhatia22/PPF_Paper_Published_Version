...
%
%\pg{Note, however, as we discuss later, we
%use these confidence thresholds a feature in PPF so the mechanism is
%retained. -- right?}
...
%% \pg{since you actually moved this table into PPF, most this discussion
%%   should actually go in the PPF arch section, I think its generic to
%%   all PPFs likely anyways.  Instead here I'd talk about how you
%%   removed the prefetch filter that was part of SPP since its redundant
%%   with the function of PPF}
...
%
%\pg{what do you mean by ``base address'' the full physical
%  address?  Be specific.  Which bits and why? You should probably also
%  talk about what you do when the number of bits is unwieldy.}
%
\newline
\newline
...
prefetch by the size of the cache blocks or by the size of a page.
 %as follows: $base\_addr >> LOG2\_BLOCK \_SIZE$ and 
%$base\_addr >> LOG2\_PAGE\_SIZE$ respectively. 
