...
%% Simple stride prefetching techniques only detect sequences of
%% addresses that differ by a constant value and fail to capture
...
%% "and correlating these with the strides, by considering each new
%% page in a vacuum."
